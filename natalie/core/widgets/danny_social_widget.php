<?php
class Danny_Social_Widget extends WP_Widget
{
	public function __construct()
    {
		$widget_ops = array( 'classname' => 'danny_social_widget', 'description' => esc_html__('A widget that displays your social icons', 'natalie') );
		parent::__construct( 'danny_social_widget', esc_html__('Danny: Social Icons', 'natalie'), $widget_ops );
	}
	...
	public function widget( $args, $instance )
    {
        ...
        <div class="social-widget">
        	<?php if($facebook) : ?><a href="<?php echo esc_url( get_theme_mod('danny_facebook') ); ?>" target="_blank"><i class="fa fa-facebook"></i></a><?php endif; ?>
        	<?php if($twitter) : ?><a href="<?php echo esc_url( get_theme_mod('danny_twitter') ); ?>" target="_blank"><i class="fa fa-twitter"></i></a><?php endif; ?>
        	<?php if($instagram) : ?><a href="<?php echo esc_url( get_theme_mod('danny_instagram') ); ?>" target="_blank"><i class="fa fa-instagram"></i></a><?php endif; ?>
        	<?php if($pinterest) : ?><a href="<?php echo esc_url( get_theme_mod('danny_pinterest') ); ?>" target="_blank"><i class="fa fa-pinterest"></i></a><?php endif; ?>
        	<?php if($bloglovin) : ?><a href="<?php echo esc_url( get_theme_mod('danny_bloglovin') ); ?>" target="_blank"><i class="fa fa-heart"></i></a><?php endif; ?>
        	<?php if($googleplus) : ?><a href="<?php echo esc_url( get_theme_mod('danny_google') ); ?>" target="_blank"><i class="fa fa-google-plus"></i></a><?php endif; ?>
        	<?php if($tumblr) : ?><a href="<?php echo esc_url( get_theme_mod('danny_tumblr') ); ?>" target="_blank"><i class="fa fa-tumblr"></i></a><?php endif; ?>
        	<?php if($youtube) : ?><a href="<?php echo esc_url( get_theme_mod('danny_youtube') ); ?>" target="_blank"><i class="fa fa-youtube-play"></i></a><?php endif; ?>
        	<?php if($dribbble) : ?><a href="<?php echo esc_url( get_theme_mod('danny_dribbble') ); ?>" target="_blank"><i class="fa fa-dribbble"></i></a><?php endif; ?>
        	<?php if($soundcloud) : ?><a href="<?php echo esc_url( get_theme_mod('danny_soundcloud') ); ?>" target="_blank"><i class="fa fa-soundcloud"></i></a><?php endif; ?>
        	<?php if($vimeo) : ?><a href="<?php echo esc_url( get_theme_mod('danny_vimeo') ); ?>" target="_blank"><i class="fa fa-vimeo-square"></i></a><?php endif; ?>        	
        </div><?php
		echo $after_widget;
	}
...
add_action( 'widgets_init', 'danny_social_init' );
function danny_social_init() {
	register_widget( 'Danny_Social_Widget' );
}